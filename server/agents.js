...
### 분석 우선순위
1. **네이버 키워드** — "한국 사람들이 무엇을 검색하는가?" (관심/의도)
2. **무신사 랭킹** — "한국 사람들이 무엇을 구매하는가?" (행동/결과)
3. **TikTok 해시태그** — "글로벌에서 무엇이 뜨고 있는가?" (선행 트렌드)
4. 세 데이터를 교차하면 "글로벌에서 뜨지만 한국에 아직 안 온 트렌드"를 발견할 수 있습니다
